    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-5" id="textblok">
          <div class="row" id="bovenkanttekst"><h1 class="text-center">BMI berekenen</h1></div>
          <div class="row">
            <div class="col-1"></div>
            <div class="col-8" id="form">
                <form name="bmi" method="post" action="" >
                    ...
                    BMI: 
                    <input id="knop2" type="text" name="BMI" value="<?php
                     if ($_SERVER["REQUEST_METHOD"] == "POST") {
                      $gewicht = $_POST["gewicht"] ?? 0;
                      $lengte = $_POST["lengte"] ?? 0;
                      if ($gewicht && $lengte)
                      {
        ...
        <div class="col-6"><img id="foto" src="BMI.png" height="300px"></div>
      </div>
      <div class="col"><img id="foto2" src="bmi.jpg" height="500px"></div>
    </div>
    <div class="container-fluid">
