<?php
// Klassen includen voor database en sessie
...
if (isset($_POST["blogTitle"])) {
    ...
    // Nieuwe blog aanmaken en velden vullen
    $blog = new Blog();
    ...
    // Blog opslaan in database
    $blog->insert();

    // Redirect naar admin met succesbericht
    header("location: admin.php?message=Blog is toegevoegd");
    exit();
}
?>
...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="../images/more.png">
        ...
        <div class="row">
            <div class="col">
                <form method="post" enctype="multipart/form-data">
                    <input type="text" id="blogTitle" name="blogTitle" placeholder="Titel" required><br><br>
                    <input type="text" id="blogAuteur" name="blogAuteur" placeholder="Auteur" required><br><br>
                    <input class="form-control" type="file" id="blogFoto" name="bestand"><br>
                    <label><strong>Inhoud:</strong></label><br>
                    <textarea class="jqte" id="content" name="content" required></textarea><br>
