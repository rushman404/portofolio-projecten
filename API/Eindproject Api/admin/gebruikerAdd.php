...
if (isset($_POST["voornaam"])) {
    ...
    header("Location: gebruiker.php?message=User is toegevoegd");
    exit;
}
?>
...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col">
                <form method="post">
                    <input type="text" id="user" name="voornaam" placeholder="Voornaam" required><br><br>
                    <input type="text" id="user" name="achternaam" placeholder="Achternaam" required><br><br>
                    <input type="text" id="user" name="email" placeholder="Email" required><br><br>
                    <input type="text" id="user" name="username" placeholder="Username" required><br><br>
                    <input type="text" id="user" name="password" placeholder="Password" required><br><br>
