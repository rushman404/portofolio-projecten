...
//zoek op id 
$id = $_GET["id"];
$scores = Score::findByUserId($id);
$user = User::findByID($id);

if (!$scores) {
    header("location: gebruiker.php?error=score niet gevonden");
    exit;
}
?>
<!doctype html>
                    ...
                    <tbody>
                        <?php foreach ($scores as $score): ?>
                            <tr>
                                ...
                                <td><?= $score->date ?></td>
                                <td>
                                    <a href="highscoresDelete.php?id=<?= $score->id; ?>" onclick="return confirm('Weet je zeker?')">
